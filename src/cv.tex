...
\address{Rue d'Écosse}{76000 ROUEN}    
...
\item Recherche et développement : \begin{itemize}
	\item Détection faciale et reconnaissance d'émotions,
	\item Encadrement d'un stage portant sur la simulation et la navigation autonome;\end{itemize}
...
\\\end{itemize}
Mots clés : \textbf{Node.js, CoffeeScript, C, Blade, Stylus, OpenCV, ROS, Python}.\\}
...
\cvitem{Développement}{C\#, C++, Python, JAVA, Bash, Node.js, Technologies Web.}
...
\cvitem{Divers}{Création audiovisuelle, e-sport, photographie, réalité virtuelle, robotique, véhicule autonome et exploration spatiale.}
